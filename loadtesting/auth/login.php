            ...
            <div class="card-body">
                <form action="">
                    <div class="form-group row mb-3">
                        <label for="username" class="col-sm-3 col-md-4 col-lg-6 col-xl-3 col-form-label">Username</label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <p class="mb-0 text-center">Don't have an account? <a href="../auth/register.php" class="text-decoration-none">Register</a></p>
                        </div>
                    </div>
                </form>
            </div>

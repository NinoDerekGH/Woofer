...
<body>
        ...
        <div class="row text-center py-5">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div class="card">
                    ...
                    <div class="card-footer col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalTableA">View</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mx-auto">
                <div class="card">
                    ...
                    <div class="card-footer col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalTableB">View</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div class="card">
                    ...
                    <div class="card-footer col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalTableC">View</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Modal A -->
    <div class="modal fade" id="modalTableA" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <!-- Modal B -->
    <div class="modal fade" id="modalTableB" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Available Dogs</h1>
    ...
    <!-- Modal C -->
    <div class="modal fade" id="modalTableC" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Available Dogs</h1>
